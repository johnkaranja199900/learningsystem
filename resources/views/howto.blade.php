    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                ...
                <p>All students willing to take online classes are requested to make their application via online registration using this <a href="{{ URL('register')}}">link </a> and fill in the data in the provided form.  </p>
                ...
                <div class="row g-2">
                    ...
                    <p class="mb-2" style="text-align: left; font-weight: bold;">Application fee can be deposited in the school Bank account:</p>
                ...
                <div class=" col-lg-6 col-md-6">
                    <p class="mb-2" style="text-align: left; font-weight: bold;">Application fee can be deposited via School Paybill</p>
                        ...
                        <p class="mb-2" style="text-align: left; font-weight: bold;">Paybill No: 222111 </p>
                        <p class="mb-2" style="text-align: left; font-weight: bold;">Account No: 2248375  </p> 
                        <p class="mb-2" style="text-align: left; font-weight: bold;">Account name: Petcom college</p> 
                    </p>
                </div>
                </div>
            </div>
