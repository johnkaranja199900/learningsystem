    ...
    <div>
     ...
     <div class="main-panel">
        <div class="content-wrapper">
            <div id="announcement" class="announcement" style=" color: red; text-transform: uppercase;" >
                <h3 id="latestAnnouncement" class="slide-in">{{ optional($latestAnnouncement)->message ?? '' }}</h3>
            </div>
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h3 class="font-weight-bold">Welcome {{Auth::user()->fname}}</h3>
                  <h6 class="font-weight-normal mb-0">Welcome at petcom college dashboard   </h6>
                  ...
                  <ul class="icon-data-list">
                    <li>
                      <div class="d-flex">
                        ...
                        <div>
                          <p class="text-info mb-1">Your Information</p>
                          <p class="mb-0">Details to appear your Certificate</p>
                        </div>
                      </div>
                    </li>
                    <div class="table-responsive">
                      <table class="table table-hover">
                        <thead>
                          <tr>
                            <th>ADM NO:</th>
                            <th>{{Auth::user()->admission_number}}</th>
                        ...
                        <tbody>
                          <tr>
                            <td>Name</td>
                            <td>{{Auth::user()->fname}} {{Auth::user()->sname}} {{Auth::user()->lname}}</td>
                          </tr>
                          <tr>
                            <td>Gender</td>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      <p class="mb-4">Total Fees</p>
                      <p class="fs-30 mb-2">Ksh. {{number_format(Auth::user()->fees)}}</p>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      <p class="mb-4">Fees Paid</p>
                      <p class="fs-30 mb-2">Ksh. {{number_format(Auth::user()->paid)}}</p>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      <p class="mb-4">Remainig Balance</p>
                      <p class="fs-30 mb-2">Ksh. {{number_format($balance)}}</p>
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      <p class="mb-4">Course Taken</p>
                      <p class="fs-30 mb-2">{{Auth::user()->unit}}</p>
                ...
                <div class="card">
                    <div class="card-body">
                      <p class="card-title">Exam And Grading</p>
                      <p class="font-weight-500">Each Unit contains an Exam and parctical question which will be submitted for marking and Grading so ease certificate generation.Grading will be as follow:- </p>
                      <div class="d-flex flex-wrap mb-5">
                        <div class="mr-5 mt-3">
                          <p class="text-muted">Above</p>
                          <h3 class="text-primary fs-30 font-weight-medium">80%</h3>
                          <p class="text-muted">Distiction</p>
                        </div>
                        <div class="mr-5 mt-3">
                          <p class="text-muted">Above</p>
                        ...
                        <div class="mr-5 mt-3">
                          <p class="text-muted">Above</p>
                          <h3 class="text-primary fs-30 font-weight-medium">50%</h3>
                          <p class="text-muted">Pass</p>
                        </div>
                        <div class="mt-3">
                          <p class="text-muted">Below</p>
                          <h3 class="text-primary fs-30 font-weight-medium">50%</h3>
                          <p class="text-muted">Fail</p>
                        </div> 
                      </div>
                      <p class="text-muted">Incase of fail, The student will be subject to supplementary Exam.</p>
                    </div>
                  </div>
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card1">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Mode of Fees Payment</p>
                  <p class="font-weight-500">For you to be able to access Learning Materials, you will be required to pay more than Half of the Fees (i.e Ksh. 2500) and others to be paid as you progress.</p>
                  <div class="d-flex flex-wrap mb-5">
                    <div class="mr-5 mt-3">
                      <p class="text-muted">After Registration</p>
                      <h4 class="text-primary fs-30 font-weight-medium"> 2,500/=</h4>

                    </div>
                    <div class="mr-5 mt-3">
                      <p class="text-muted">After 5<sup>th</sup> Unit</p>
                      <h4 class="text-primary fs-30 font-weight-medium">1,500/=</h4>
                    </div>
                    <div class="mr-5 mt-3">
                  ...
                  <p class="font-weight-500">For total Fees Payble to be 5,500/=</p>
                  <p class="font-weight-500">All the fees must be paid Using Either School Paybill or Via Bank Account</p>
                </div>
              </div>
            </div>
            
            @if (Auth::user()->paid >=2500)
            
            @php
                $unit = Auth::user()->unit;
                $filteredLinks = $meetingLinks->where('unit', $unit);
            @endphp
            ...
            @if ($filteredLinks->count() > 0)
                <div class="col-md-6 grid-margin stretch-card1">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Available Class Links</h4>
                            <p class="card-description">
                                Click The class link to join {{ $unit }} class:
                            </p>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                    ...
                                    <tbody>
                                        @foreach($filteredLinks as $link)
                                            <tr>
                                                <td>{{ $link->title }}</td>
                                                <td><a href="{{ $link->url }}" target="_blank" class="badge badge-danger"> join class</a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                ...
                <div class="col-md-6 grid-margin stretch-card1">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Available Class Links</h4>
                            <p class="card-description">
                                There are no class links available for {{ $unit }} class.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <p class="card-title">Pay your fees to view your course details</p>
                        </div>
                        <p class="font-weight-500">Once the fees is paid your class link will be open and indicated here.</p>
                    </div>
                </div>
            </div>
        @endif
        ...
        <script>
            $(document).ready(function() {
                // Call the triggerAnnouncement function after the document is ready
                triggerAnnouncement();
            });
        
            function triggerAnnouncement() {
                var announcement = $("#latestAnnouncement");
        
                // Remove existing announcement
                announcement.remove();
        
                // Create a new announcement element
                var newAnnouncement = $("<h3>").attr("id", "latestAnnouncement").addClass("slide-in").text("{{ optional($latestAnnouncement)->message ?? '' }}");
        
                // Append the new announcement to the announcement container
                $("#announcement").append(newAnnouncement);
        
                // Trigger the slide-in animation
                setTimeout(function () {
                    newAnnouncement.css("transform", "translateX(0)");
                }, 100);
            }
        </script>
