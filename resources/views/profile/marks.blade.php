        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Marks and grading to appear in your certificate</p>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ getGrade($result->introduction) }}</td>
                                </tr>
                                <tr>
                                    <td>Windows</td>
                                    <td>{{ $result->windows }}</td>
                                    <td>{{ getGrade($result->windows) }}</td>
                                </tr>
                                <tr>
                                    <td>Word</td>
                                    <td>{{ $result->word }}</td>
                                    <td>{{ getGrade($result->word) }}</td>
                                </tr>
                                <tr>
                                    <td>Excel</td>
                                    <td>{{ $result->excel }}</td>
                                    <td>{{ getGrade($result->excel) }}</td>
                                </tr>
                                <tr>
                                    <td>Access</td>
                                    <td>{{ $result->access }}</td>
                                    <td>{{ getGrade($result->access) }}</td>
                                </tr>
                                <tr>
                                    <td>Powerpoint</td>
                                    <td>{{ $result->powerpoint }}</td>
                                    <td>{{ getGrade($result->powerpoint) }}</td>
                                </tr>
                                <tr>
                                    <td>Publisher</td>
                                    <td>{{ $result->publisher }}</td>
                                    <td>{{ getGrade($result->publisher) }}</td>
                                </tr>
                                <tr>
                                    <td>Pagemaker</td>
                                    <td>{{ $result->pagemaker }}</td>
                                    <td>{{ getGrade($result->pagemaker) }}</td>
                                </tr>
                                <tr>
                                    <td>DOS</td>
                                    <td>{{ $result->DOS }}</td>
                                    <td>{{ getGrade($result->DOS) }}</td>
                                </tr>
                                <tr>
                                    <td>Internet</td>
                                    <td>{{ $result->internet }}</td>
                                    <td>{{ getGrade($result->internet) }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
