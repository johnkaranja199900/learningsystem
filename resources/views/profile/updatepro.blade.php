    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="{{ route('updateprof') }}" class="mt-6 space-y-6">
                @csrf
                @method('patch')
              <div class="form-group row">
                <label for="exampleInputMobile" class="col-sm-3 col-form-label">First Name</label>
                <div class="col-sm-9">
                    <x-text-input class="form-control" id="name" name="fname" type="text" class="mt-1 block w-full" :value="old('name', $user->fname)" required autofocus autocomplete="name" />
                </div>
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
              </div>
              <div class="form-group row">
                <label for="exampleInputMobile" class="col-sm-3 col-form-label">Second Name</label>
                <div class="col-sm-9">
                    <x-text-input class="form-control" id="name" name="sname" type="text" class="mt-1 block w-full" :value="old('name', $user->sname)" required autofocus autocomplete="name" />
                </div>
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <x-text-input class="form-control" id="name" name="lname" type="text" class="mt-1 block w-full" :value="old('name', $user->lname)" required autofocus autocomplete="name" />
                </div>
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <x-text-input class="form-control" id="name" name="gender" type="text" class="mt-1 block w-full" :value="old('name', $user->gender)" required autofocus autocomplete="name" />
                </div>
                <x-input-error :messages="$errors->updatePassword->get('gender')" class="mt-2" />
              </div>
