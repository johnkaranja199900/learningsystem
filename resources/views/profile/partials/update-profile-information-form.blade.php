...
<div>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $user->fname)" required autofocus autocomplete="name" />
          ...
          <div class="card-body">
            ...
            <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="name" id="exampleInputMobile"  :value="old('name', $user->fname)" required autofocus autocomplete="name" >
                </div>
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input  class="form-control" name="email" type="email" id="exampleInputMobile"  :value="old('email', $user->email)" required autocomplete="username">
                  <x-text-input id="email" name="email" type="email" class="mt-1 block w-full" :value="old('email', $user->email)" required autocomplete="username" />
                </div>
                <x-input-error class="mt-2" :messages="$errors->get('email')" />
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="gender" id="exampleInputConfirmPassword2" :value="old('email', $user->gender)" required autocomplete="username">
                </div>
